...
namespace DGame
{
    class TestComponent final : public DECS::Component::StrictRegistrar<TestComponent>
    {
    public:
    ...
    {
        TestEvent() = default;
        TestEvent(DECS::Entity a_entity, float32 a_old_value, float32 a_new_value)
        {
            entity      = a_entity;
    ...
    class TestSystem : public DECS::System::StrictRegistrar<TestSystem>
    {
    public:
        TestSystem() = default;
        ~TestSystem() = default;
        ...
        inline virtual void Update(DECS::Universe* const a_universe) override
        {
