...
#include "shaders/vs_debugdraw_lines.bin.h"
#include "shaders/fs_debugdraw_lines.bin.h"
#include "shaders/vs_debugdraw_lines_stipple.bin.h"
#include "shaders/fs_debugdraw_lines_stipple.bin.h"
#include "shaders/vs_debugdraw_fill.bin.h"
#include "shaders/vs_debugdraw_fill_mesh.bin.h"
#include "shaders/fs_debugdraw_fill.bin.h"
#include "shaders/vs_debugdraw_fill_lit.bin.h"
#include "shaders/vs_debugdraw_fill_lit_mesh.bin.h"
#include "shaders/fs_debugdraw_fill_lit.bin.h"
#include "shaders/vs_debugdraw_fill_texture.bin.h"
#include "shaders/fs_debugdraw_fill_texture.bin.h"
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->init(s_dde.m_defaultEncoder);
}
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->push();
}

void DebugDrawEncoder::pop()
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->pop();
}

void DebugDrawEncoder::setDepthTestLess(bool _depthTestLess)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setDepthTestLess(_depthTestLess);
}

void DebugDrawEncoder::setState(bool _depthTest, bool _depthWrite, bool _clockwise)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setState(_depthTest, _depthWrite, _clockwise);
}

void DebugDrawEncoder::setColor(uint32_t _abgr)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setColor(_abgr);
}

void DebugDrawEncoder::setLod(uint8_t _lod)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setLod(_lod);
}

void DebugDrawEncoder::setWireframe(bool _wireframe)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setWireframe(_wireframe);
}

void DebugDrawEncoder::setStipple(bool _stipple, float _scale, float _offset)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setStipple(_stipple, _scale, _offset);
}

void DebugDrawEncoder::setSpin(float _spin)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setSpin(_spin);
}

void DebugDrawEncoder::setTransform(const void* _mtx)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setTransform(_mtx);
}

void DebugDrawEncoder::setTranslate(float _x, float _y, float _z)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->setTranslate(_x, _y, _z);
}

void DebugDrawEncoder::pushTransform(const void* _mtx)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->pushTransform(_mtx, 1);
}

void DebugDrawEncoder::popTransform()
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->popTransform();
}

void DebugDrawEncoder::moveTo(float _x, float _y, float _z)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->moveTo(_x, _y, _z);
}

void DebugDrawEncoder::moveTo(const bx::Vec3& _pos)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->moveTo(_pos);
}

void DebugDrawEncoder::lineTo(float _x, float _y, float _z)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->lineTo(_x, _y, _z);
}

void DebugDrawEncoder::lineTo(const bx::Vec3& _pos)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->lineTo(_pos);
}

void DebugDrawEncoder::close()
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->close();
}

void DebugDrawEncoder::draw(const bx::Aabb& _aabb)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_aabb);
}

void DebugDrawEncoder::draw(const bx::Cylinder& _cylinder)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_cylinder, false);
}

void DebugDrawEncoder::draw(const bx::Capsule& _capsule)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(*((const bx::Cylinder*)&_capsule), true);
}

void DebugDrawEncoder::draw(const bx::Disk& _disk)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_disk);
}

void DebugDrawEncoder::draw(const bx::Obb& _obb)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_obb);
}

void DebugDrawEncoder::draw(const bx::Sphere& _sphere)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_sphere);
}

void DebugDrawEncoder::draw(const bx::Triangle& _triangle)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_triangle);
}

void DebugDrawEncoder::draw(const bx::Cone& _cone)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCone(_cone.pos, _cone.end, _cone.radius);
}

void DebugDrawEncoder::draw(GeometryHandle _handle)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(_handle);
}
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(true, _numVertices, _vertices, _numIndices, _indices);
}
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->draw(false, _numVertices, _vertices, _numIndices, _indices);
}

void DebugDrawEncoder::drawFrustum(const void* _viewProj)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawFrustum(_viewProj);
}

void DebugDrawEncoder::drawArc(Axis::Enum _axis, float _x, float _y, float _z, float _radius, float _degrees)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawArc(_axis, _x, _y, _z, _radius, _degrees);
}

void DebugDrawEncoder::drawCircle(const bx::Vec3& _normal, const bx::Vec3& _center, float _radius, float _weight)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCircle(_normal, _center, _radius, _weight);
}

void DebugDrawEncoder::drawCircle(Axis::Enum _axis, float _x, float _y, float _z, float _radius, float _weight)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCircle(_axis, _x, _y, _z, _radius, _weight);
}

void DebugDrawEncoder::drawQuad(const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawQuad(_normal, _center, _size);
}

void DebugDrawEncoder::drawQuad(SpriteHandle _handle, const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawQuad(_handle, _normal, _center, _size);
}
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCone(_from, _to, _radius);
}

void DebugDrawEncoder::drawCylinder(const bx::Vec3& _from, const bx::Vec3& _to, float _radius)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCylinder(_from, _to, _radius, false);
}

void DebugDrawEncoder::drawCapsule(const bx::Vec3& _from, const bx::Vec3& _to, float _radius)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawCylinder(_from, _to, _radius, true);
}

void DebugDrawEncoder::drawAxis(float _x, float _y, float _z, float _len, Axis::Enum _highlight, float _thickness)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawAxis(_x, _y, _z, _len, _highlight, _thickness);
}
...
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawGrid(_axis, _center, _size, _step);
}

void DebugDrawEncoder::drawOrb(float _x, float _y, float _z, float _radius, Axis::Enum _highlight)
{
	reinterpret_cast<DebugDrawEncoderImpl*>(this)->drawOrb(_x, _y, _z, _radius, _highlight);
}
