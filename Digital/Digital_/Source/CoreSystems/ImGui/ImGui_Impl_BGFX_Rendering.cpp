...
namespace DImGui
{
	...
	void ImGui_ImplBGFX_RenderDrawData(ImDrawData* a_draw_data, bgfx::ViewId a_view_id)
	{
        ...
        //INFOLOG("ViewID: " << a_view_id << " DrawData DisplayPos: " << a_draw_data->DisplayPos.x << " - " << a_draw_data->DisplayPos.y << " --- " << a_draw_data->DisplaySize.x << " - " << a_draw_data->DisplaySize.y);
        //INFOLOG("ViewID: " << a_view_id << " DrawData DisplaySize:);
