...
namespace DFW
{
    namespace DResource
    {
        ResourceHandle<DResource::ImageData> ResourceManager::Load(std::string_view const a_resource_identifer, uint8 const* a_data, size_t const a_data_size)
        {
        ...
        ResourceHandle<DRender::TextureData> ResourceManager::Load(std::string_view const a_resource_identifer, DResource::ImageData const* const a_image)
        {
